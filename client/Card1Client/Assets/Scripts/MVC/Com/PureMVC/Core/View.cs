...
namespace PureMVC.Core
{
    ...
    public class View : IView
    {
		...
		protected View()
		{
			...
			m_observerMap = new Dictionary<NotificationID, IList<IObserver>>();
            InitializeView();
		}
		...
		public virtual void NotifyObservers(INotification notification)
		{
			...
			lock (m_syncRoot)
			{
                ...
                if (m_observerMap.TryGetValue(notification.Name,out observers_ref))
				{
                   // observers = new List<IObserver>(observers_ref); 不考虑回调时 列表发生改变
		...
		public virtual void RegisterMediator(IMediator mediator)
		{
			lock (m_syncRoot)
			{
                ...
                IList<NotificationID> interests = mediator.ListNotificationInterests();
        ...
        /// </summary>
        protected IDictionary<NotificationID, IList<IObserver>> m_observerMap;
