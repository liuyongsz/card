...
namespace PureMVC.Interfaces
{
    ...
    public interface INotifier
    {
        ...
        void SendNotification(NotificationID notificationName);
        ...
        void SendNotification(NotificationID notificationName, object body);
        ...
        void SendNotification(NotificationID notificationName, object body, string type);
