...
namespace PureMVC.Interfaces
{
    ...
    public interface IFacade : INotifier
	{
        ...
        IProxy RetrieveProxy(ProxyID proxyName);
        ...
        IProxy RemoveProxy(ProxyID proxyName);
        ...
        bool HasProxy(ProxyID proxyName);
        ...
        void RegisterCommand(NotificationID notificationName, Type commandType);
        ...
        void RemoveCommand(NotificationID notificationName);
        ...
        bool HasCommand(NotificationID notificationName);
