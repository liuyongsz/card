...
public class UIAtlas : MonoBehaviour
{
    ...
    public enum SCALE_PLATFORM : int
    {
        WEB = 0,
        STANDALONE, 
        IPHONE,
    ...
    public float scaleX
    {
        get
        {
            int platformValue;
#if UNITY_WEBPLAYER
            platformValue = (int)SCALE_PLATFORM.WEB;
#elif UNITY_STANDALONE
            platformValue = (int)SCALE_PLATFORM.STANDALONE;
#elif UNITY_IPHONE
            platformValue = (int)SCALE_PLATFORM.IPHONE;
#elif UNITY_ANDROID
            platformValue = (int)SCALE_PLATFORM.ANDROID;
#elif UNITY_FLASH
            platformValue = (int)SCALE_PLATFORM.FLASHP_LAYER;
#else
            platformValue = (int)SCALE_PLATFORM.SIZE;
#endif
            if (scales == null || platformValue * 2 >= scales.Length)
            {
                return 1;
            }
            else
            {
                return scales[platformValue * 2];
            }
        }
    }
    ...
    public float scaleY
    {
        get
        {
            ...
            {
                return scales[platformValue * 2 + 1];
            }
        }
    }
