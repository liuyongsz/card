...
struct  NetIncomingMessageType_t4279120760 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(NetIncomingMessageType_t4279120760, ___value___1)); }
