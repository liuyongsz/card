...
struct  NetMessageType_t191235414 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(NetMessageType_t191235414, ___value___1)); }
