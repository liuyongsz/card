...
struct  ExpandMTUStatus_t3530790055 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(ExpandMTUStatus_t3530790055, ___value___1)); }
