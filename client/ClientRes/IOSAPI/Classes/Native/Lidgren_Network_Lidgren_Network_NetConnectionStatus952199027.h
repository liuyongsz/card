...
struct  NetConnectionStatus_t952199027 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(NetConnectionStatus_t952199027, ___value___1)); }
