...
struct QuaternionOptions_t466049668_marshaled_pinvoke
{
	int32_t ___rotateMode_0;
	int32_t ___axisConstraint_1;
	Vector3_t2243707580_marshaled_pinvoke ___up_2;
};
// Native definition for marshalling of: DG.Tweening.Plugins.Options.QuaternionOptions
struct QuaternionOptions_t466049668_marshaled_com
{
	int32_t ___rotateMode_0;
	int32_t ___axisConstraint_1;
	Vector3_t2243707580_marshaled_com ___up_2;
};
